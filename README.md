...
| --- | --- | --- | --- |
| Android | Beta | [Android APK](https://github.com/Daozhu1007/FluentMai/releases/tag/v0.2.6-beta) | Primary maintained platform; debug-signed test build |
...
- `v0.2.6-beta` — Android debug-signed test APK.
